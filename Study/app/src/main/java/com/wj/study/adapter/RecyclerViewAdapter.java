    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        switch (viewType) {
            case ITEM_VIEW_TYPE_TITLE: {
                View titleView = LayoutInflater.from(parent.getContext()).inflate(R.layout.title, null);
            ...
            case ITEM_VIEW_TYPE_CONTENT:
                View contentView = LayoutInflater.from(parent.getContext()).inflate(R.layout.content, null);
