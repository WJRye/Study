 ...
 * Description: 圆形进度条
 */
public class ProgressViewWithStatus extends View {
    /**
     * 圆的度数
     */
    ...
    public ProgressViewWithStatus(Context context) {
        super(context);
    }

    public ProgressViewWithStatus(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ProgressViewWithStatus(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    @TargetApi(21)
    public ProgressViewWithStatus(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
