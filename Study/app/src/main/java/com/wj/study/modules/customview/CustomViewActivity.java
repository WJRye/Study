...
public class CustomViewActivity extends BaseActivity {
    ...
    public void initViews() {
        int[] ids = {R.id.item_character_view, R.id.item_progress_view, R.id.item_audio_view};
        int[] stringIds = {R.string.character_view, R.string.progress_view, R.string.audio_view};
