 ...
 */
public class ProgressViewWithoutStatus extends View {
    /**
     * 圆的度数
     */
    ...
    public ProgressViewWithoutStatus(Context context) {
        super(context);
    }

    public ProgressViewWithoutStatus(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ProgressViewWithoutStatus(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    @TargetApi(21)
    public ProgressViewWithoutStatus(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
